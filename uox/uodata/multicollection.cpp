...
//=========================================================
multicollection::multicollection(const std::filesystem::path &uodir,tiledata *info ){
	this->info = info ;
	if (!uodir.empty()){
		load(uodir,info);
	}
...
//=========================================================
auto multicollection::load(const std::filesystem::path &uodir,const std::string &housingbin,tiledata *info) ->bool {
	_multis.clear();
...
//=========================================================
auto multicollection::loadMul(const std::filesystem::path &uodir,tiledata *info)->bool {
	_multis.clear();
	this->info = info ;
	auto rvalue = false ;
...
//=========================================================
auto multicollection::load(const std::filesystem::path &uodir,tiledata *info) ->bool {
	auto rvalue = false ;
