...
//=========================================================
//=========================================================
terraininfo_t::terraininfo_t():tileinfo_t(),texture(invalid_tile) {
}
//=========================================================
// artinfo_t items
//=========================================================
//=========================================================
artinfo_t::artinfo_t():tileinfo_t(),weight(0),layer(0),miscData(0),unk2(0),quantity(0),animid(invalid_tile),unk3(0),hue(0),stackingOffset(0),value(0),height(0) {
}
...
// multi_item
//=========================================================
multi_item::multi_item() :tileid(invalid_tile),altitude(0),offsetx(0),offsety(0),info(nullptr),flag(0){
